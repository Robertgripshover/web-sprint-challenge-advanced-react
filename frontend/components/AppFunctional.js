...
export default function AppFunctional(props) {
  ...
  const getXY = (coordinates) => {
    ...
    if (state.board.indexOf('B') === 1) {return coordinates = "(2, 1)"}
    if (state.board.indexOf('B') === 2) {return coordinates = "(3, 1)"}
    if (state.board.indexOf('B') === 3) {return coordinates = "(1, 2)"}
    if (state.board.indexOf('B') === 4) {return coordinates = "(2, 2)"}
    if (state.board.indexOf('B') === 5) {return coordinates = "(3, 2)"}
    if (state.board.indexOf('B') === 6) {return coordinates = "(1, 3)"}
    if (state.board.indexOf('B') === 7) {return coordinates = "(2, 3)"}
